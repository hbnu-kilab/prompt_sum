...
3. 전체 대화를 파악하여 입력된 summary에 도움이 되는 문장들 선별해주세요.
4. 인삿말이나 추임새, extractive summary와 관련 없는 문장들은 제외합니다.
5. [SUM_IDS]를 제외한 선별된 문장의 id들만 출력하면 되며, 전체 문장의 30% 만큼 출력하세요. 출력 형식은 다음 조건을 따르면 됩니다.
6. 선별한 문장의 id를 다음과 같이 0, 1, 2, ... 나열되는 형식으로 [결과 id 리스트]: 뒤에 출력하세요.
